...
CREATE TABLE "new_Evento" (
    ...
    "boxDireccionOverride" TEXT NOT NULL DEFAULT '',
...
INSERT INTO "new_Evento" ("boxCiudadOverride", "boxDiaOverride", "boxEtiquetaEntradaOverride", "boxFechaOverride", "boxHoraOverride", "boxLugarOverride", "boxPrecioOverride", "createdAt", "descripcion", "esDestacado", "esExterno", "estaAgotado", "estaPublicado", "fecha", "flyerUrl", "hora", "id", "invitado", "linkExterno", "nombre", "updatedAt") SELECT "boxCiudadOverride", "boxDiaOverride", "boxEtiquetaEntradaOverride", "boxFechaOverride", "boxHoraOverride", "boxLugarOverride", "boxPrecioOverride", "createdAt", "descripcion", "esDestacado", "esExterno", "estaAgotado", "estaPublicado", "fecha", "flyerUrl", "hora", "id", "invitado", "linkExterno", "nombre", "updatedAt" FROM "Evento";
DROP TABLE "Evento";
...
CREATE TABLE "new_Home" (
    ...
    "boxDireccion" TEXT NOT NULL DEFAULT 'Calle 23 entre 43 y 44, Barrio La Loma',
    "boxCiudad" TEXT NOT NULL DEFAULT 'La Plata',
    "boxEtiquetaEntrada" TEXT NOT NULL DEFAULT 'Anticipada online',
    "updatedAt" DATETIME NOT NULL
);
INSERT INTO "new_Home" ("boxCiudad", "boxEtiquetaEntrada", "boxLugar", "id", "slider1Url", "slider2Url", "slider3Url", "textoEvento", "totalEdiciones", "totalPersonas", "totalShows", "updatedAt", "youtubeUrl") SELECT "boxCiudad", "boxEtiquetaEntrada", "boxLugar", "id", "slider1Url", "slider2Url", "slider3Url", "textoEvento", "totalEdiciones", "totalPersonas", "totalShows", "updatedAt", "youtubeUrl" FROM "Home";
DROP TABLE "Home";
